            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                        ...
                        <img src="https://img.icons8.com/pastel-glyph/64/null/name.png" alt="Profile"
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-menu-button-wide"></i><span>Mes demandes</span><i
                ...
                <div class="px-4 py-6">
                    <nav aria-label="Main Nav" class="flex flex-col mt-6 space-y-1">
                        ...
                        <details class="group [&_summary::-webkit-details-marker]:hidden">
                            <summary class="flex items-center px-4 py-2 text-gray-500 rounded-lg cursor-pointer
                  {{ (request()->is('enrolement/index')) ? 'bg-red-100' : '' }}
                  {{ (request()->is('exoneration/index')) ? 'bg-red-100' : '' }}
                  {{ (request()->is('convetion/index')) ? 'bg-red-100' : '' }}

                    hover:bg-gray-100 hover:text-gray-700">
                                <img src="https://img.icons8.com/emoji/48/null/open-file-folder-emoji.png" width="16"
                                    height="16" />
                            ...
                            <nav aria-label="Teams Nav" class="mt-1.5 ml-8 flex flex-col">
                                ...
                                <a href="{{ route('convention.index') }}" ²²
                                    class="flex items-center px-4 py-2  {{ (request()->is('convetion/index')) ? 'bg-gray-100' : '' }} text-gray-500 rounded-lg hover:bg-gray-100 hover:text-gray-700">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 opacity-75" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        ...
                        <a href="{{ route('profile.index') }}" class="flex items-center px-4 py-2 text-gray-500 rounded-lg
                {{ (request()->is('profile/index')) ? 'bg-red-100' : '' }}
                hover:bg-gray-100 hover:text-gray-700">
                            <img src="https://img.icons8.com/ios-filled/50/null/user-male-circle.png" width="16"
                                height="16" />

                            <span class="ml-3 text-sm font-medium"> Profil </span>
                        </a>

                        <a href="/aide" class="flex items-center px-4 py-2
                {{ (request()->is('aide')) ? 'bg-red-100' : '' }}
                text-gray-500 rounded-lg hover:bg-gray-100 hover:text-gray-700">
                            <img src="https://img.icons8.com/ios-filled/50/null/info-squared.png" width="16"
                                height="16" />
                        ...
                        <a href="/"
                            class="flex items-center px-4 py-2 text-gray-500 rounded-lg hover:bg-gray-100 hover:text-gray-700">
                            <img src="https://img.icons8.com/ios-glyphs/30/null/circled-left.png" width="16"
                                height="16" />
