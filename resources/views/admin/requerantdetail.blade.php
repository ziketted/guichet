        ...
        <div class="row">
            ...
            <div class="col-lg-10">
                ...
                <div class="row">
                    ...
                    <h5 class="card-title p-3"><i>Requerant :</i> {{$profile->name}}</h5>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Responsable de la structure</h5>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body ">
                                ...
                                <p class="text-sm">
                                <h3>Bénéficiaire : <b>{{$profile->beneficiaire}} </b></h3>
                                <h3>Projet en cours : <b><span class="badge bg-info">{{$profile->fourniture}}
                                    </b></span></h3>
                                <h3>Impact : <b>{{$profile->impact}}
                                    </b></h3>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body ">
                                ...
                                <p class="text-sm">
                                <h3>Domaine : <b><span class="badge bg-warning">{{$profile->domaine}}
                                    </b></span></h3>
                                <h3>Fournisseur : <b>{{$profile->fourniture}} </b></h3>
                                <h3>Rayon d'intervention : <b>{{$profile->rayon_intervention}} </b></h3>
                    ...
                    <h5 class="card-title p-3">Documents</h5>
                    <div class="col-lg-3">
                        <div class="card">
                            <div class="card-body">
                                <div class="activity">
                                    <div class="activity-item d-flex">
                                        <div class="row ">
                                            ...
                                            <a href="" class="fw-bold text-dark">
                                                <img
                                                    src="https://img.icons8.com/external-flat-icons-inmotus-design/50/null/external-empty-printer-control-ui-elements-flat-icons-inmotus-design.png" />
                                                Statut juridique
                                            </a>
                                            ...
                                            <div class="col-8 p-3">
                                                <a href="{{Storage::url($profile->doc_statut)}}"
                                                    download="Statut juridique" class="fw-bold text-dark"> Statut
                                                    juridique </a>
                                                <hr>
                                            </div>
                                            @endif
                                ...
                                <div class="activity">
                                    <div class="activity-item d-flex">
                                        <div class="row ">
                                            ...
                                            <div class="col-4 p-2 mt-2">
                                                <div class="activity-content">
                                                    <a href="{{Storage::url($profile->doc_accord)}}"
                                                        download="Accord juridique">
                                                        <img
                                                            src="https://img.icons8.com/stickers/50/null/live-folder.png" />
                                                    </a>
                                                </div>
                                            ...
                                            <div class="col-8 p-3">
                                                <a href="{{Storage::url($profile->doc_accord)}}"
                                                    download="Statut juridique" class="fw-bold text-dark"> Accord
                                                    juridique </a>
                                                <hr>
                                            </div>
                                            @endif
                                ...
                                <div class="activity">
                                    <div class="activity-item d-flex">
                                        <div class="row ">
                                            ...
                                            <div class="col-4 p-2 mt-2">
                                                <div class="activity-content">
                                                    <a href="{{Storage::url($profile->doc_autorisation)}}"
                                                        download="Autorisation juridique">
                                                        <img
                                                            src="https://img.icons8.com/stickers/50/null/live-folder.png" />
                                                    </a>
                                                </div>
                                            ...
                                            <div class="col-8 p-3">
                                                <a href="{{Storage::url($profile->doc_autorisation)}}"
                                                    download="Autorisation juridique" class="fw-bold text-dark">
                                                    Autorisation juridique </a>
                                                <hr>
                                            </div>
                                            @endif
                                        </div>
                                    ...
                                    <div class="activity-item d-flex">
                                        <div class="row ">
                                            ...
                                            <div class="col-4 p-2 mt-2">
                                                <div class="activity-content">
                                                    <a href="{{Storage::url($profile->doc_autorisation)}}"
                                                        download="Personnalité juridique">
                                                        <img
                                                            src="https://img.icons8.com/stickers/50/null/live-folder.png" />
                                                    </a>
                                                </div>
                                            ...
                                            <div class="col-8 p-3">
                                                <a href="{{Storage::url($profile->doc_personnalite)}}"
                                                    download="Personnalité juridique" class="fw-bold text-dark">
                                                    Personnalité juridique </a>
                                                <hr>
                                            </div>
                                            @endif
                                        </div>
                                ...
                                <div class="activity">
                                    <div class="activity-item d-flex">
                                        <div class="row ">
                                            ...
                                            <div class="col-4 p-2 mt-2">
                                                <div class="activity-content">
                                                    <a href="{{Storage::url($profile->doc_convention)}}"
                                                        download="Statut juridique">
                                                        <img
                                                            src="https://img.icons8.com/stickers/50/null/live-folder.png" />
                                                    </a>
                                ...
                                <div class="activity">
                                    <div class="activity-item d-flex">
                                        <div class="row ">
                                            ...
                                            <div class="col-8 p-3">
                                                <a href="{{Storage::url($profile->doc_certificat)}}"
                                                    download="Certificat juridique" class="fw-bold text-dark">
                                                    Certificat juridique </a>
                                                <hr>
                                            </div>
                                            @endif
                                        </div>
                    ...
                    <div class="col-12">
                        <div class="overflow-auto card recent-sales">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Les exonérations</h5>
                    ...
                    <div class="card-body ">
                        <br>
                        <h3 class="card-title text-danger">Aucun document et/ou renseignement concernant le requerant
                        </h3>
                    ...
                    <div class="col-12">
                        <div class="overflow-auto card recent-sales">
                            ...
                            <div class="card-body">
                                                        ...
                                                        <div class="row ">
                                                            ...
                                                            <div class="col-8 p-3">
                                                                <a href="{{Storage::url($profile->doc_statut)}}"
                                                                    ...
                                                                    download="Statut juridique"> Statut juridique </a>
                                                                <hr>
                                                            </div>
                                                            @endif
                                                        </div>
                                ...
                                <div class="card-body ">
                                    <br>
                                    <h3 class="card-title text-danger">Aucun document et/ou renseignement concernant le
                                        requerant</h3>
                                    <p>Prière demander au requérant de bien rensiegner ses informations. </p>
                                    <br>
                                    <button class="btn btn-primary"> Notifier le requerant </button>
