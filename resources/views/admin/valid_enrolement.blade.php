                        ...
                        <article class="rounded-lg border border-gray-100 bg-white p-6">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-2xl font-medium text-gray-900">{{$enrolementTotal}}</p>
                                </div>
                        ...
                        <article class="rounded-lg border border-gray-100 bg-white p-6">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-2xl font-medium text-gray-900">{{$enrolementValider}}</p>
                                </div>
                        ...
                        <article class="rounded-lg border border-gray-100 bg-white p-6">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-2xl font-medium text-gray-900">{{$enrolementAnnuler}}</p>
                                </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> <a href="{{Storage::url($enrolement->lettre)}}" download="lettre">
                                                    <i class="bi bi-download text-gray"> Téléchargez la lettre</i></a>
                                            </td>
                                            <td><span
                                                    class="badge {{$enrolement->statut}} p-2">{{$enrolement->statut}}</span>
                                            </td>
                                            <td>{{$enrolement->created_at}}</td>
                                            <td>

                                                <a href="{{url("valider/".$enrolement->id)}}" class="btn
                                                    btn-warning"><i class="bi bi-pen-fill"></i></a>
