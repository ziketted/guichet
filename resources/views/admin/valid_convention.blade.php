                ...
                <article class="rounded-lg border border-gray-100 bg-white p-6">
                  <div class="flex items-center justify-between">
                    <div>
                      ...
                      <p class="text-2xl font-medium text-gray-900">{{$requerantNombre}}</p>
                    </div>
                  ...
                  <table class="table table-borderless">
                    ...
                    <tbody>
                        @foreach ($conventions as $item)
                            <tr>
                                <td>{{$item->name}}</td>
                                <td> <a href="{{$item->programme_social}}" download="Programme social">
                                    <i class="bi bi-download text-gray"> Téléchargez le programme</i></a></td>
                                <td><span class="badge {{$item->statut}}  p-2">{{$item->statut}}</span></td>
                                <td>{{$item->created_at}}</td>
                                <td>
                                    <a href="{{route('admin.validerconvention', $item->id)}}" class="btn btn-warning"><i class="bi bi-pen-fill"></i></a>
