                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @foreach ($exonerations as $exoneration )
                            ...
                            <form action="{{ route('exoneration.upd_lettre') }} " class="row g-3" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                @if (is_null($exoneration->lettre) || $exoneration->lettre=='' )
                                <div class="col-md-8" id="update">
                                    <div class="mb-3 row">
                                        <label for="inputNumber" class="col-sm-10 col-form-label">Lettre à la Direction du
                                            FNPSS</label>
                                        <div class="col-sm-10">
                            ...
                            <form action="{{ route('exoneration.upd_attestation') }} " class="row g-3" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                @if (is_null($exoneration->attestation) || $exoneration->attestation=='' )
                                <div class="col-md-8">
                                    <div class="mb-3 row">
                                        <label for="inputNumber" class="col-sm-10 col-form-label">Attestation des biens à
                                            exonerer</label>
                                        <div class="col-sm-10">
                            ...
                            <form action="{{ route('exoneration.upd_copie_avis') }} " class="row g-3" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                @if (is_null($exoneration->copie_avis) || $exoneration->copie_avis=='' )
                                <div class="col-md-8">
                                    <div class="mb-3 row">
                                        <label for="inputNumber" class="col-sm-10 col-form-label">Avis favorable du
                                            Ministère</label>
                                        <div class="col-sm-10">
                            ...
                            <form action="{{ route('exoneration.upd_liste_colisage') }} " class="row g-3" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                            ...
                            <form action="{{ route('exoneration.upd_projet') }} " class="row g-3" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="col-md-8">
                                    <div class="mb-3 row">
                                        <label for="inputNumber" class="col-sm-10 col-form-label">Copie du projet
                                            d'utilisation des biens</label>
                                        <div class="col-sm-10">
                            ...
                            <form action="{{ route('exoneration.upd_transport') }} " class="row g-3" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="col-md-8">
                                    <div class="mb-3 row">
                                        <label for="inputNumber" class="col-sm-10 col-form-label">Lettre de
                                            transport</label>
                                        <div class="col-sm-10">
                            ...
                            <form action="{{ route('exoneration.upd_facture') }} " class="row g-3" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                            ...
                            <form action="{{ route('exoneration.upd_affectation') }} " class="row g-3" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="col-md-8">
                                    <div class="mb-3 row">
                                        <label for="inputNumber" class="col-sm-10 col-form-label">Rapport d'affectation des
                                            biens exonérés</label>
                                        <div class="col-sm-10">
                            ...
                            <form action="{{ route('exoneration.upd_type') }} " class="row g-3" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="col-md-8">
                            ...
                            <form action="{{ route('exoneration.upd_commentaire') }} " class="row g-3" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="col-md-8">
                                    <div class="form-floating">
