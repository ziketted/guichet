          ...
          <div class="col-lg-5 d-flex align-items-end" data-aos="fade-up" data-aos-delay="300">
            <div class="content ps-0 ps-lg-5">
              ...
              <div class="position-relative mt-4">
                <img src="{{ asset('assets-home/img/about-2.jpg') }}" class="img-fluid" alt="">
        ...
        <div class="tab-content" data-aos="fade-up" data-aos-delay="300">
          ...
          <div class="tab-pane fade active show" id="menu-starters">
            ...
            <div class="row gy-5">
              ...
              <div class="col-lg-4 menu-item">
                <a href="{{ asset('assets-home/img/menu/menu-item-3.png') }}" class="glightbox"><img src="assets/img/menu/menu-item-3.png" class="menu-img img-fluid" alt=""></a>
                <h4>Est Eligendi</h4>
                <p class="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
              ...
              <div class="col-lg-4 menu-item">
                <a href="{{ asset('assets-home/img/menu/menu-item-4.png') }}" class="glightbox"><img src="assets/img/menu/menu-item-4.png" class="menu-img img-fluid" alt=""></a>
                <h4>Eos Luibusdam</h4>
                <p class="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
              ...
              <div class="col-lg-4 menu-item">
                <a href="{{ asset('assets-home/img/menu/menu-item-5.png') }}" class="glightbox"><img src="assets/img/menu/menu-item-5.png" class="menu-img img-fluid" alt=""></a>
                <h4>Eos Luibusdam</h4>
                <p class="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
              ...
              <div class="col-lg-4 menu-item">
                <a href="{{ asset('assets-home/img/menu/menu-item-6.png') }}" class="glightbox"><img src="assets/img/menu/menu-item-6.png" class="menu-img img-fluid" alt=""></a>
          ...
          <div class="tab-pane fade" id="menu-breakfast">
            ...
            <div class="row gy-5">
              ...
              <div class="col-lg-4 menu-item">
                <a href="{{ asset('assets-home/img/menu/menu-item-1.png') }}" class="glightbox"><img src="assets/img/menu/menu-item-1.png" class="menu-img img-fluid" alt=""></a>
                <h4>Magnam Tiste</h4>
                <p class="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
              ...
              <div class="col-lg-4 menu-item">
                <a href="{{ asset('assets-home/img/menu/menu-item-2.png') }}" class="glightbox"><img src="assets/img/menu/menu-item-2.png" class="menu-img img-fluid" alt=""></a>
                <h4>Aut Luia</h4>
                <p class="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
